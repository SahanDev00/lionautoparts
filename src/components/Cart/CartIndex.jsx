...
const CartIndex = () => {
  ...
  doc.text(`Total: Rs.${formatPrice(total)}`, 14, finalY + 10);

  doc.save('Lion_Auto_Parts_Quotation.pdf');
};
    ...
    <div className="w-full pt-[50px] min-h-screen">
      ...
      {cartItems.length === 0 ? (
        ...
        <div>
              ...
              <li key={item.itemID} className="flex justify-between mb-4 py-4 border-b">
                <div className="flex items-center w-[85%]">
                  ...
                  <div className='md:flex items-center justify-between w-full'>
                    <div>
                      <h2 className="text-sm sm:text-xl text-orange-500 font-semibold font-overpass">{item.itemName}</h2>
          ...
          <div className="w-[90%] xl:w-[85%] mx-auto pb-5 gap-4 flex items-center justify-end mt-4">
            <button onClick={handleCheckout} className="bg-green-500 text-white py-2 px-4 rounded font-overpass">Check Out</button>
